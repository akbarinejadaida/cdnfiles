!(function (e, r) {
  "object" == typeof exports && "undefined" != typeof module
    ? (module.exports = r(require("react"), require("react-dom/client")))
    : "function" == typeof define && define.amd
    ? define(["react", "react-dom/client"], r)
    : ((e =
        "undefined" != typeof globalThis ? globalThis : e || self).TypoGeraphy =
        r(e.React));
})(this, function (e) {
  "use strict";
  function r(e) {
  ...
  const v = (e) => {
    ...
    S = (e) => M(e) || z.has(e) || k.test(e),
    I = (e) => H(e, "length", J),
    M = (e) => Boolean(e) && !Number.isNaN(Number(e)),
    E = (e) => H(e, "number", M),
    $ = (e) => Boolean(e) && Number.isInteger(Number(e)),
    O = (e) => e.endsWith("%") && M(e.slice(0, -1)),
    R = (e) => w.test(e),
    T = (e) => j.test(e),
    ...
    U = x(() => {
      ...
      return {
        ...
        theme: {
          ...
          gradientColorStopPositions: [O, I],
          inset: G(),
          margin: G(),
          opacity: H(),
          padding: N(),
        ...
        classGroups: {
          ...
          "line-clamp": [{ "line-clamp": ["none", M, E] }],
          leading: [
            {
              leading: [
                "none",
  ...
  return function (e) {
    var r = e.as,
      ...
      n = e.className,
      l = e.children;
    return o.default.createElement(t, { className: V(n) }, l);
  };
});
