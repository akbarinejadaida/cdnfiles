!(function (e, r) {
  "object" == typeof exports && "undefined" != typeof module
    ? r(exports, require("react"), require("react-dom"))
    : "function" == typeof define && define.amd
    ? define(["exports", "react", "react-dom"], r)
    : r(
        ((e =
          "undefined" != typeof globalThis ? globalThis : e || self).Navbar =
          {}),
        e.React,
        e.ReactDOM
      );
  ...
  const i = (e) => {
      ...
      return {
        getClassGroupId: (e) => {
          const o = e.split("-");
          return "" === o[0] && 1 !== o.length && o.shift(), d(o, r) || p(e);
        },
    ...
    u = (e) => {
      ...
      return (
        g(Object.entries(e.classGroups), o).forEach(([e, o]) => {
          b(o, t, e, r);
        }),
        t
      );
  ...
  const j = (e) => {
    ...
    R = (e) => $(e) || G.has(e) || N.test(e),
    I = (e) => Q(e, "length", U),
    $ = (e) => Boolean(e) && !Number.isNaN(Number(e)),
    q = (e) => Q(e, "number", $),
    L = (e) => Boolean(e) && Number.isInteger(Number(e)),
    D = (e) => e.endsWith("%") && $(e.slice(0, -1)),
    T = (e) => C.test(e),
    W = (e) => M.test(e),
    ...
    Z = z(() => {
      ...
      return {
        ...
        classGroups: {
          ...
          grow: [{ grow: E() }],
          shrink: [{ shrink: E() }],
          order: [{ order: ["first", "last", "none", L, T] }],
          "grid-cols": [{ "grid-cols": [K] }],
          "col-start-end": [{ col: ["auto", { span: ["full", L, T] }, T] }],
          "col-start": [{ "col-start": P() }],
          "col-end": [{ "col-end": P() }],
          "grid-rows": [{ "grid-rows": [K] }],
          "row-start-end": [{ row: ["auto", { span: [L, T] }, T] }],
          ...
          "text-decoration-thickness": [
            { decoration: ["auto", "from-font", R, I] },
          ],
          "underline-offset": [{ "underline-offset": ["auto", R, T] }],
          ...
          "outline-offset": [{ "outline-offset": [R, T] }],
          "outline-w": [{ outline: [R, I] }],
          "outline-color": [{ outline: [e] }],
          "ring-w": [{ ring: M() }],
          "ring-w-inset": ["ring-inset"],
          "ring-color": [{ ring: [e] }],
          "ring-opacity": [{ "ring-opacity": [h] }],
          "ring-offset-w": [{ "ring-offset": [R, I] }],
          "ring-offset-color": [{ "ring-offset": [e] }],
          shadow: [{ shadow: ["", "inner", "none", W, J] }],
          ...
          contrast: [{ contrast: [i] }],
          "drop-shadow": [{ "drop-shadow": ["", "none", W, T] }],
  ...
  function oe(e) {
    ...
    return (
        ...
        function () {
          !(function () {
            if (
              a &&
              ("undefined" != typeof window &&
                ((window.React = n.default), (window.ReactDOM = l.default)),
              a.navLink)
            ) {
              var e = a.navLink.style,
                r = a.navLink.component;
              e && re("link", e),
                r &&
                  re("script", r, function () {
                    var e = window.NavLink;
                    e
                      ? c(function () {
                          return e;
                        })
                      : console.error("Nav Link component not loaded");
                  });
            }
          })();
        },
      ...
      n.default.createElement(
        "div",
        { className: ee("flex items-center gap-2 navbar", t) },
        d &&
          o.map(function (e, r) {
            return n.default.createElement(
              d,
              s({ key: e.label + e.link + r }, e)
            );
          })
      )
    );
  }
  "undefined" != typeof window && (window.Navbar = oe),
    (e.Navbar = oe),
